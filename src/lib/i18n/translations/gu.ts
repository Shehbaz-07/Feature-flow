...
const gu: Translations = {
  ...
  groups: {
    ...
    cancel: "રદ કરો", creating: "બનаઈ રહ્યા…", createGroup: "ગ્રૂપ બનાવો",
    saving: "સાચવી રહ્યા…", saveChanges: "ફેરફાર સાચવો",
    deleteTitle: "ભૂંસો", deleteDesc: "આ ક્રિયા પૂર્વવત્ કરી શકાતી નથી.",
    deleteGroup: "ગ્રૂપ ભૂંસો", groupCreated: "બનાવ્યો",
    groupUpdated: "ગ્રૂપ સફળતાપૂર્વક અપડેટ થયો", groupDeleted: "ભૂંસ્યો",
  },
  sdkDocs: {
    title: "SDK દસ્તાવેજીકરણ",
    subtitle: "તમારી ઍપમાં FeatureFlow થોડી મિનિટોમાં જોડો — 7 ભાષાઓ સમર્થિત.",
    supported: "સમર્થિત:",
    sections: "વિભાગો",
    copied: "કૉપિ કર્યું",
    copy: "કૉપિ કરો",
    apiRefTitle: "API સંદર્ભ —",
    colParam: "પરિમાણ",
    colType: "પ્રકાર",
    colRequired: "જરૂરી",
    colDesc: "વર્ણન",
    ...
    cardRestDesc: "કોઈપણ ભાષા માટે સુસંગત એક HTTP એન્ડપોઇન્ટ.",
    cardRolloutTitle: "નિર્ધારિત રોલઆઉટ",
    cardRolloutDesc: "વપરાશકર્તા દીઠ સમાન પરિણામ.",
    cardCacheTitle: "સર્વર કૅશ",
    cardCacheDesc: "1 ms કરતાં ઓછો સમય લે છે.",
    sectionInstallLabel: "ઇન્સ્ટોલેશન",
    sectionInstallDesc: "તમારી ભાષા માટે SDK ઇન્સ્ટોલ કરો અથવા REST API નો સીધો ઉપયોગ કરો.",
    sectionInitLabel: "પ્રારંભ કરો",
    sectionInitDesc: "તમારું API URL અને પર્યાવરણ ID સેટ કરો.",
    sectionEvalLabel: "ફ્લેગ ચકાસો",
    sectionEvalDesc: "વપરાશકર્તા માટે ફીચર ફ્લેગ ચાલુ છે કે કેમ તે ચકાસો.",
    sectionRolloutLabel: "ટકાવારી રોલઆઉટ",
    sectionRolloutDesc: "રોલઆઉટ કેવી રીતે કાર્ય કરે છે તે સમજો.",
    paramFlagKey: "ફીચર ફ્લેગની વિશિષ્ટ કી.",
    paramEnvId: "લક્ષ્ય પર્યાવરણનો UUID.",
    paramUserId: "રોલઆઉટ માટે વપરાશકર્તા ID.",
    paramGroups: "વપરાશકર્તાના ગ્રૂપ.",
  },
}
